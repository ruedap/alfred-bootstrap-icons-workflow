...
The current supported version is **Bootstrap Icons 1.2.0**. Previous versions are available [here](https://github.com/ruedap/alfred-bootstrap-icons-workflow/releases).
